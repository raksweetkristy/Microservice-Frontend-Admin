    ...
    <div>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
            <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-5">
                <img src="https://cartzilla.createx.studio/img/logo-dark.png" class="h-6 me-3 sm:h-7" alt="Flowbite Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap "></span>
            </a>
            <ul class="space-y-2 font-medium">
                <li>
                    <NuxtLink to="/" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100 group">
                ...
                <li>
                    <NuxtLink to="/categories" class="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
